...
{
	public class CoinYellow : Enemy
	{
		private String ANIMATION = "/Application/res/image/coin_yellow.png"; 
		private static int w = 16;
		private static int h = 18;
	
		public CoinYellow(GenerateObstacles obs, Map map, Bomberman player, GraphicsContext g, Vector2 scale) :
