...
{
	public class GhostYellow : Enemy
	{
		private String ANIMATION = "/Application/res/image/ghost_yellow.png"; 
		private static int w = 16;
		private static int h = 18;
	
		public GhostYellow(GenerateObstacles obs, Map map, Bomberman player, GraphicsContext g, Vector2 scale) : base(obs, map, player, g, scale) {
