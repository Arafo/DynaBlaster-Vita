...
{
	public class GhostPink : Enemy
	{
		private String ANIMATION = "/Application/res/image/ghost_pink.png"; 
		private static int w = 16;
		private static int h = 18;
	
		public GhostPink(GenerateObstacles obs, Map map, Bomberman player, GraphicsContext g, Vector2 scale) :
