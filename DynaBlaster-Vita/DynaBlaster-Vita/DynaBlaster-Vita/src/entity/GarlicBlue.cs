...
{
	public class GarlicBlue : Enemy
	{
		private String ANIMATION = "/Application/res/image/garlic_blue.png"; 
		private static int w = 16;
		private static int h = 18;
	
		public GarlicBlue(GenerateObstacles obs, Map map, Bomberman player, GraphicsContext g, Vector2 scale) : base(obs, map, player, g, scale) {
