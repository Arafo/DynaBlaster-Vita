...
{
	public class GhostWhite : Enemy
	{
		private String ANIMATION = "/Application/res/image/ghost_white.png"; 
		private static int w = 16;
		private static int h = 18;
	
		public GhostWhite(GenerateObstacles obs, Map map, Bomberman player, GraphicsContext g, Vector2 scale) :
