...
{
	public class BalloonPurple : Enemy
	{
		private String ANIMATION = "/Application/res/image/balloon_purple.png"; 
		private static int w = 16;
		private static int h = 18;
	
		public BalloonPurple(GenerateObstacles obs, Map map, Bomberman player, GraphicsContext g, Vector2 scale) : base(obs, map, player, g, scale) {
