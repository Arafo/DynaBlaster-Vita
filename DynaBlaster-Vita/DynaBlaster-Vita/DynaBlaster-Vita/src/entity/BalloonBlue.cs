...
{
	public class BalloonBlue : Enemy
	{
		private String ANIMATION = "/Application/res/image/balloon_blue.png"; 
		private static int w = 16;
		private static int h = 18;
	
		public BalloonBlue(GenerateObstacles obs, Map map, Bomberman player, GraphicsContext g, Vector2 scale) :
