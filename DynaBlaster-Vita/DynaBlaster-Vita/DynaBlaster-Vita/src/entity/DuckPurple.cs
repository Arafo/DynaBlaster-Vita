...
{
	public class DuckPurple : Enemy
	{
		private String ANIMATION = "/Application/res/image/duck_purple.png"; 
		private static int w = 16;
		private static int h = 18;
	
		public DuckPurple(GenerateObstacles obs, Map map, Bomberman player, GraphicsContext g, Vector2 scale) :
