...
{
	public class GhostBlue : Enemy
	{
		private String ANIMATION = "/Application/res/image/ghost_blue.png"; 
		private static int w = 16;
		private static int h = 18;
	
		public GhostBlue(GenerateObstacles obs, Map map, Bomberman player, GraphicsContext g, Vector2 scale) : base(obs, map, player, g, scale) {
