...
{
	public class FishGreen : Enemy
	{
		private String ANIMATION = "/Application/res/image/fish_green.png"; 
		private static int w = 16;
		private static int h = 18;
	
		public FishGreen(GenerateObstacles obs, Map map, Bomberman player, GraphicsContext g, Vector2 scale) : base(obs, map, player, g, scale) {
