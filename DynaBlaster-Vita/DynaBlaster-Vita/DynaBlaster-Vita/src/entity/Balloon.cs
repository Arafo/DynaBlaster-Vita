...
namespace DynaBlasterVita
{
	...
	{
		private String ANIMATION = "/Application/res/image/balloon.png"; 
		private static int w = 16;
		private static int h = 18;
	
		public Balloon(GenerateObstacles obs, Map map, Bomberman player, GraphicsContext g, Vector2 scale) : base(obs, map, player, g, scale) {
			...
			this.down = new Animation(mov, 10, Animation.Direction.DOWN);
