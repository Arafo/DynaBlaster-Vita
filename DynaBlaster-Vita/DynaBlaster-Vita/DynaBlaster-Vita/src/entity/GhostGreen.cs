...
{
	public class GhostGreen : Enemy
	{
		private String ANIMATION = "/Application/res/image/ghost_green.png"; 
		private static int w = 16;
		private static int h = 18;
	
		public GhostGreen(GenerateObstacles obs, Map map, Bomberman player, GraphicsContext g, Vector2 scale) :
