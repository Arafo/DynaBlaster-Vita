...
{
	public class CrocodileGreen : Enemy
	{
		private String ANIMATION = "/Application/res/image/crocodile_green.png.png"; 
		private static int w = 16;
		private static int h = 18;
	
		public CrocodileGreen(GenerateObstacles obs, Map map, Bomberman player, GraphicsContext g, Vector2 scale) : base(obs, map, player, g, scale) {
